...
CREATE TABLE IF NOT EXISTS `db_loja_games.`.`(tb_produtos` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_(tb_produtos_tb_categorias_idx` (`categoria_id` ASC) VISIBLE,
  INDEX `fk_(tb_produtos_tb_usuarios1_idx` (`usuario_id` ASC) VISIBLE,
  CONSTRAINT `fk_(tb_produtos_tb_categorias`
    FOREIGN KEY (`categoria_id`)
    REFERENCES `db_loja_games.`.`tb_categorias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_(tb_produtos_tb_usuarios1`
